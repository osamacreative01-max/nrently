...
export const metadata: Metadata = {
  ...
  description:
    "Luxury car rental in Pakistan — Mercedes-Benz CLA200 and S400, Audi A4 and A5 for weddings and VIP travel.",
};
  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Mercedes-Benz and Audi executive sedans with chauffeur options — the first impression you can drive to — from PKR 15,000/day."
